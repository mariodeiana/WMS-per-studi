> Documento storico superato: consultare il README principale e AGENTS.md.
...
pratica. Audit e fascicolo restano separati; Supervisore e Validatore possono
...
- **http://127.0.0.1:8000/** per la Scheda Pratica Supervisore: assegnazioni,
...
LIPE sono distribuiti tra i due operatori e seguono un grafo orientato: i demo sono concatenati in avanti. Solo i nodi
raggiunti ed eseguibili compaiono nel lavoro operativo.
...
Configurazione, migrazione minima e decisioni di modello: [workflow-grafo.md](docs/workflow-grafo.md).
