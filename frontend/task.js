...
function renderAttachmentMeta(){
  ...
  container.innerHTML=`<div class="attachment-table"><div class="attachment-head"><span>Documento</span><span>Descrizione</span><span>Tipo documento</span><span></span></div>${rows}</div>`;
